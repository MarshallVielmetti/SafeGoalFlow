...
FEATURE_CACHE=$GOALFLOW_DIR/exp/training_cache # set your feature_cache path
VOC_PATH=$GOALFLOW_DIR/data/cluster_points_8192_.npy
CHECKPOINT_PATH=$GOALFLOW_DIR/data/goalflow_traj_epoch_54-step_18260.ckpt
GOAL_POINT_SCORES=$GOALFLOW_DIR/data/goal_point_scores
