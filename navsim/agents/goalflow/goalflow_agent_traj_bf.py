...
from navsim.agents.goalflow.goalflow_model_traj_bf import GoalFlowTrajModelBf
...
class GoalFlowTrajAgentBf(AbstractAgent):
    def __init__(
        self,
        ...
        self._goalflow_model = GoalFlowTrajModelBf(config)
